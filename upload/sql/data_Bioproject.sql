...
--
-- Table structure for table `Bioproject`
--
...
CREATE TABLE `Bioproject` (
  ...
  `BioprojectAccession` varchar(255) NOT NULL,
  `Name` text NOT NULL,
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18786 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
